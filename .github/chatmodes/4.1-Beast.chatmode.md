...
tools: ['codebase', 'editFiles', 'fetch', 'problems', 'runCommands', 'search', 'supabase', 'apply_migration', 'deploy_edge_function', 'execute_sql', 'generate_typescript_types', 'get_advisors', 'get_organization', 'get_project', 'get_project_url', 'list_edge_functions', 'list_migrations', 'list_organizations', 'list_projects', 'list_tables']
