...
- `gpt-5.1-codex-max` (codex-cli & openai): supports none, minimal, low, medium, high, xhigh reasoning
- `gpt-5.2` (codex-cli & openai): supports none, minimal, low, medium, high, xhigh reasoning  
