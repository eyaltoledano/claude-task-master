...
} from '../shared/utils/state-monitor.js';
...
describe('State Refactor - Zustand Stores', () => {
	...
	describe('UI Store', () => {
		...
		test('should reset UI state correctly', () => {
			const { setError, setShowCommandPalette, resetUIState } =
				useUIStore.getState();
	...
	describe('Data Store', () => {
		...
		test('should provide computed getters', () => {
			const { setTasks, getTaskById, getTasksByStatus } =
	...
	describe('Preferences Store', () => {
		test('should persist preferences correctly', () => {
			const { setCurrentTheme, setCompactMode } =
		...
		test('should provide theme getters', () => {
			const { setCurrentTheme, getEffectiveTheme } =
				usePreferencesStore.getState();
	...
	describe('Performance Monitoring', () => {
		...
		test('should validate store structure', () => {
			const uiStore = useUIStore;
			const validation = storeValidation.validateStore(uiStore, 'ui', [
				'loading',
				'error',
				'currentScreen'
			]);
	...
	describe('Store Integration', () => {
		...
		test('stores should work together correctly', () => {
			...
			act(() => {
				useDataStore
					.getState()
					.setTasks([{ id: '1', title: 'Test Task', status: 'pending' }]);
