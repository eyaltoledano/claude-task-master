...
Thumbs.db`,
        ...
        await this.gitCommand('commit', '-m', 'Initial commit: Setup test repository');
    }
    ...
    async testGitBasicOperations() {
        ...
        try {
            ...
            try {
                ...
                basicTests.push({ name: 'Git Status', success: false, error: error.message });
            }
            ...
            try {
                ...
                basicTests.push({ 
                    name: 'Git Log', 
                    success: logResult.exitCode === 0 && logResult.stdout.includes('Initial commit')
                });
            } catch (error) {
                basicTests.push({ name: 'Git Log', success: false, error: error.message });
            }
            ...
            try {
                ...
                basicTests.push({ 
                    ...
                    success: branchResult.exitCode === 0 && branchResult.stdout.includes('main')
                });
            } catch (error) {
                basicTests.push({ name: 'Git Branch List', success: false, error: error.message });
            }
            ...
            try {
                ...
                basicTests.push({ 
                    name: 'Git Config', 
                    success: configResult.exitCode === 0 && configResult.stdout.trim() === 'Test User'
                });
            } catch (error) {
                basicTests.push({ name: 'Git Config', success: false, error: error.message });
            }
            ...
            try {
                ...
                const commitResult = await this.gitCommand('commit', '-m', 'Add temporary test file');
                ...
                basicTests.push({ name: 'Git Add/Commit/Remove', success: false, error: error.message });
            }
    ...
    async testGitConfiguration() {
        ...
        try {
            ...
            try {
                ...
                const hasRequiredConfigs = listResult.stdout.includes('user.name=') && 
        ...
        try {
            ...
            try {
                ...
                stateTests.push({
                    ...
                    success: statusResult.exitCode === 0 && statusResult.stdout.trim() === ''
                });
            } catch (error) {
                stateTests.push({ name: 'Clean Repository', success: false, error: error.message });
            }
            ...
            try {
                ...
                stateTests.push({ name: 'Modified Files Detection', success: false, error: error.message });
            }
            ...
            try {
                ...
                stateTests.push({ name: 'Untracked Files Detection', success: false, error: error.message });
            }
            ...
            try {
                ...
                stateTests.push({ name: 'Staged Changes Detection', success: false, error: error.message });
            }
            ...
            try {
                ...
                stateTests.push({ name: 'Commit History', success: false, error: error.message });
            }
    ...
    async testBranchOperations() {
        ...
        try {
            ...
            try {
                ...
                branchTests.push({ name: 'Branch Creation', success: false, error: error.message });
            }
            ...
            try {
                ...
                branchTests.push({ name: 'Branch Commits', success: false, error: error.message });
            }
            ...
            try {
                ...
                branchTests.push({ name: 'Branch Switching', success: false, error: error.message });
            }
            ...
            try {
                ...
                const featureFile = path.join(this.testProjectRoot, 'feature.js');
                const fileExists = await fs.access(featureFile).then(() => true).catch(() => false);
                ...
                branchTests.push({ name: 'Branch Merging', success: false, error: error.message });
            }
            ...
            try {
                ...
                branchTests.push({ name: 'Branch Deletion', success: false, error: error.message });
            }
    ...
    async testMergeConflicts() {
        ...
        try {
            ...
            try {
                ...
                await fs.writeFile(conflictFile, 'Version A content\nShared line\nVersion A ending');
                ...
                await fs.writeFile(conflictFile, 'Version B content\nShared line\nVersion B ending');
                await this.gitCommand('add', 'conflict.txt');
            ...
            try {
                ...
                const hasConflict = mergeResult.exitCode !== 0 || mergeResult.stderr.includes('CONFLICT');
    ...
    async testGitHooks() {
        ...
        try {
            ...
            try {
                ...
                const hookScript = this.gitInfo.platform === 'win32' 
            ...
            try {
                ...
                const commitResult = await this.gitCommand('commit', '-m', 'Test hook execution');
    ...
    async testWorktreeManagement() {
        ...
        try {
            ...
            try {
                ...
                const hasMainWorktree = listResult.stdout.includes(this.testProjectRoot);
            ...
            try {
                const worktreePath = path.join(path.dirname(this.testProjectRoot), 'git-test-worktree');
                ...
                // Create worktree
                await this.gitCommand('worktree', 'add', worktreePath, 'worktree-branch');
    ...
    async testSubmoduleHandling() {
        ...
        try {
            ...
            try {
                ...
                const gitmodulesExists = await fs.access(gitmodulesPath).then(() => true).catch(() => false);
        ...
        try {
            ...
            try {
                ...
                for (let i = 0; i < 50; i++) {
                    ...
                    const filepath = path.join(this.testProjectRoot, 'perf-test', filename);
                    filePromises.push(
                        fs.mkdir(path.dirname(filepath), { recursive: true })
                        .then(() => fs.writeFile(filepath, `// Performance test file ${i}\nconsole.log('File ${i}');`))
                    );
                }
                ...
                await fs.rm(path.join(this.testProjectRoot, 'perf-test'), { recursive: true, force: true });
    ...
    async testGitIntegrationFeatures() {
        ...
        try {
            ...
            try {
                ...
                await fs.writeFile(path.join(ignoredDir, 'package.js'), 'module.exports = {};');
                ...
                const statusResult = await this.gitCommand('status', '--porcelain');
                const ignoresWorking = !statusResult.stdout.includes('node_modules') && 
            ...
            // Test Git attributes
            try {
                const gitattributesPath = path.join(this.testProjectRoot, '.gitattributes');
    ...
    printResults() {
        ...
        if (!overallSuccess) {
            console.log(`⚠️ Some Git integration issues detected. Review failed tests above.`);
        }
    }
}
