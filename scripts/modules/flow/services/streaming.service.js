...
export class ProgressTracker {
  ...
  _emitProgress(progress, phase, message) {
    ...
    const progressMessage = MessageFormatter.progress(this.executionId, progress, phase, message)
...
export class StreamingService {
  ...
  emitLog(executionId, level, message, details = null) {
    const emitter = this.executionEmitters.get(executionId)
    if (emitter) {
      const logMessage = MessageFormatter.log(executionId, level, message, details)
