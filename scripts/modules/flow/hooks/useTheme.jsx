...
export function useComponentTheme(componentName, overrides = {}) {
	...
	const getThemedProps = useCallback(
		(props = {}) => {
			...
			if (
				resolvedTheme.text &&
				typeof resolvedTheme.text === 'string' &&
				!props.color
			) {
			...
			if (
				...
				typeof resolvedTheme.background === 'string' &&
...
export function useThemedStyles() {
	...
	const createConditionalStyle = useCallback(
	...
	const createVariantStyles = useCallback(
		(variants) => {
