...
import { Alert, Badge, Select, TextInput, ConfirmInput, StatusMessage, Spinner } from '@inkjs/ui';
import { useConfiguration } from './ConfigurationProvider.jsx';

const TabButton = ({ label, isActive, badgeText }) => (
	<Box paddingX={1} borderStyle={isActive ? 'double' : 'single'} borderColor={isActive ? 'cyan' : 'gray'}>
...
const AutoMergeTab = () => {
	const { getConfigValue, updateConfig, hasError, getError } = useConfiguration();
		...
		<Box flexDirection="column" padding={1}>
			...
			<Box marginTop={1} flexDirection="column">
				...
				<Box marginTop={1}>
					...
					/>
					<Text color={getConfigValue('autoMerge.strictMode') ? 'yellow' : 'green'}>
			...
			<Box marginTop={1} flexDirection="column">
				...
				<TextInput
					...
					defaultValue={getConfigValue('autoMerge.recentActivityWindow', '30 minutes ago')}
					onSubmit={(value) => updateConfig('autoMerge.recentActivityWindow', value)}
				/>
			...
			<Box marginTop={1} flexDirection="column">
				...
				<TextInput
					...
					onSubmit={(value) => updateConfig('autoMerge.maxRetries', parseInt(value))}
				/>
			...
			<Box marginTop={1} flexDirection="column">
				...
				<TextInput
					...
					onSubmit={(value) => updateConfig('autoMerge.retryDelay', parseInt(value))}
				/>
	...
	return (
		<Box flexDirection="column" padding={1}>
			...
			<Box marginTop={1} flexDirection="column">
				...
				<ConfirmInput
					message=""
					onConfirm={() => updateConfig('autoMerge.safetyChecks.validatePRState', true)}
					onCancel={() => updateConfig('autoMerge.safetyChecks.validatePRState', false)}
				/>
				<Text color={getConfigValue('autoMerge.safetyChecks.validatePRState', true) ? 'green' : 'red'}>
					{getConfigValue('autoMerge.safetyChecks.validatePRState', true) ? 'Enabled' : 'Disabled'}
				</Text>
			</Box>
			...
			<Box marginTop={1} flexDirection="column">
				...
				<ConfirmInput
					message=""
					onConfirm={() => updateConfig('autoMerge.safetyChecks.validateRequiredChecks', true)}
					onCancel={() => updateConfig('autoMerge.safetyChecks.validateRequiredChecks', false)}
				/>
				<Text color={getConfigValue('autoMerge.safetyChecks.validateRequiredChecks', true) ? 'green' : 'red'}>
					{getConfigValue('autoMerge.safetyChecks.validateRequiredChecks', true) ? 'Enabled' : 'Disabled'}
				</Text>
			</Box>
			...
			<Box marginTop={1} flexDirection="column">
				...
				<ConfirmInput
					message=""
					onConfirm={() => updateConfig('autoMerge.safetyChecks.validateNoConflicts', true)}
					onCancel={() => updateConfig('autoMerge.safetyChecks.validateNoConflicts', false)}
				/>
				<Text color={getConfigValue('autoMerge.safetyChecks.validateNoConflicts', true) ? 'green' : 'red'}>
					{getConfigValue('autoMerge.safetyChecks.validateNoConflicts', true) ? 'Enabled' : 'Disabled'}
				</Text>
			</Box>
			...
			<Box marginTop={1} flexDirection="column">
				...
				<ConfirmInput
					message=""
					onConfirm={() => updateConfig('autoMerge.safetyChecks.validateRecentActivity', true)}
					onCancel={() => updateConfig('autoMerge.safetyChecks.validateRecentActivity', false)}
				/>
				<Text color={getConfigValue('autoMerge.safetyChecks.validateRecentActivity', true) ? 'green' : 'red'}>
					{getConfigValue('autoMerge.safetyChecks.validateRecentActivity', true) ? 'Enabled' : 'Disabled'}
				</Text>
			</Box>
		</Box>
	);
	...
	return (
		<Box flexDirection="column" padding={1}>
			...
			<Box marginTop={1} flexDirection="column">
				...
				/>
				<Text color={getConfigValue('rollback.enabled', true) ? 'green' : 'red'}>
			...
			<Box marginTop={1} flexDirection="column">
				...
				/>
				<Text color={getConfigValue('rollback.createIncidentReport', true) ? 'green' : 'red'}>
					{getConfigValue('rollback.createIncidentReport', true) ? 'Enabled' : 'Disabled'}
				</Text>
			</Box>
			...
			<Box marginTop={1} flexDirection="column">
				...
				/>
				<Text color={getConfigValue('rollback.preserveEvidence', true) ? 'green' : 'red'}>
					{getConfigValue('rollback.preserveEvidence', true) ? 'Enabled' : 'Disabled'}
				</Text>
			</Box>
		</Box>
	);
...
const ConfigurationModal = ({ onClose, onNotification }) => {
	...
	const tabs = [
		{ label: 'Auto-Merge', component: AutoMergeTab, badge: hasChanges ? 'Modified' : null },
		...
		>
			...
			<Box marginTop={1} flexDirection="column">
				...
				<Box marginTop={1} justifyContent="space-between">
					<Box>
						<Text dimColor>Tab: Switch tabs | s: Save | r: Reset | Esc: Close</Text>
					</Box>
					<Box>
