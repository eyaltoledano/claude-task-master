...
import { colors, spacing, borderRadius, shadows, animations, utils, icons } from '../../styles/DesignSystem.js';
    ...
    <div style={toastStyles}>
      ...
      <button
        ...
        style={{
          ...
          lineHeight: 1,
          flexShrink: 0,
          transition: utils.transition(['color', 'background-color'], animations.duration[150]),
          '&:hover': {
            color: colors.neutral[700],
