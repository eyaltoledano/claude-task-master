...
import { colors, spacing, borderRadius, animations, utils } from '../../styles/DesignSystem.js';
...
const ProgressBar = ({
  ...
  const fillStyles = {
    ...
    borderRadius: borderRadius.full,
    transition: animated ? utils.transition(['width'], animations.duration[500]) : 'none',
...
export const CircularProgress = ({
  ...
  const strokeDashoffset = indeterminate ? 0 : circumference - (displayValue / 100) * circumference;
        ...
        <circle
          ...
          style={{
            transition: animated && !indeterminate ? 
              utils.transition(['stroke-dashoffset'], animations.duration[500]) : 'none',
            animation: indeterminate ? 
              `circular-indeterminate ${animations.duration[1000]} linear infinite` : 'none',
          }}
        />
      </svg>
            ...
            >
              ...
              <div
                style={{
                  ...
                  borderRadius: '50%',
                  backgroundColor: isCompleted || isCurrent ? progressColor : colors.neutral[300],
                  color: isCompleted || isCurrent ? colors.neutral[50] : colors.neutral[600],
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  ...
                  border: isCurrent ? `2px solid ${colors.neutral[50]}` : 'none',
              ...
              {step && (
                <span
                  style={{
                    ...
                    transition: utils.transition(['color', 'font-weight'], animations.duration[300]),
                  }}
                >
                  {step}
                </span>
            ...
            {index < steps.length - 1 && (
              <div
                style={{
                  flex: 1,
                  height: '2px',
                  backgroundColor: index < currentStep ? progressColor : colors.neutral[300],
                  transition: utils.transition(['background-color'], animations.duration[300]),
