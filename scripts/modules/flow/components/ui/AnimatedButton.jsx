...
import { colors, spacing, borderRadius, animations, variants, utils } from '../../styles/DesignSystem.js';
...
const AnimatedButton = ({
  ...
  const buttonStyles = {
    ...
    background: disabled ? variants.button.primary['&:disabled'].background : variantStyles.background,
    color: disabled ? variants.button.primary['&:disabled'].color || colors.neutral[500] : variantStyles.color,
        ...
        {children && (
          <span
            style={{
              ...
              transition: utils.transition(['opacity'], animations.duration[150]),
            }}
          >
            {children}
          </span>
      ...
      <style jsx>{`
        ...
        button:hover:not(:disabled) {
          background: ${!disabled && !loading ? (
            variant === 'primary' ? colors.primary[700] :
            variant === 'secondary' ? colors.neutral[300] :
            variant === 'success' ? colors.success[700] :
            variant === 'warning' ? colors.warning[700] :
            variant === 'danger' ? colors.error[700] :
            variant === 'ghost' ? colors.neutral[100] :
            variantStyles.background
          ) : variantStyles.background} !important;
