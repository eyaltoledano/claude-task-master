  ...
  return (
    <Box flexDirection="column" flexGrow={1}>
      ...
      <Box 
        ...
        marginBottom={1}
      >
        <Text bold color="cyan">Work Sessions</Text>
        <Text> • </Text>
      ...
      <Box flexDirection="column" flexGrow={1} paddingLeft={1} paddingRight={1}>
        {sessions.length === 0 ? (
          <Text dimColor>No sessions recorded yet. Start working on tasks!</Text>
        ) : (
      ...
      <Box padding={1}>
        <Text dimColor italic>
          Note: Session tracking is a preview feature. Data shown is example data.
        </Text>
      </Box>
