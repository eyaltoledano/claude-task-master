...
export default function VibeKitSetupGuide({ onClose, projectRoot }) {
	...
	const renderOverview = () => (
		<Box flexDirection="column">
			<Text color="cyan" bold>Welcome to VibeKit Integration!</Text>
			<Text marginTop={1}>
				VibeKit provides cloud-based AI agent execution with secure sandbox environments,
				GitHub automation, and advanced task management capabilities.
			</Text>
			
			<Box marginTop={2}>
				<Text color="yellow" bold>Key Features:</Text>
			...
			<Box marginTop={2}>
				<Text color="green" bold>Setup Requirements:</Text>
			...
			<Box marginTop={2} borderStyle="single" padding={1}>
				<Text color="cyan" bold>Current Status:</Text>
				<Text color={Object.values(envStatus.agents || {}).some(Boolean) ? 'green' : 'red'}>
					AI Agents: {Object.values(envStatus.agents || {}).filter(Boolean).length}/4 configured
				</Text>
				<Text color={envStatus.github ? 'green' : 'yellow'}>
					GitHub: {envStatus.github ? 'Configured' : 'Not configured'}
				</Text>
				<Text color={Object.values(envStatus.sandboxes || {}).some(Boolean) ? 'green' : 'yellow'}>
					Sandboxes: {Object.values(envStatus.sandboxes || {}).filter(Boolean).length}/3 configured
				</Text>
			</Box>
		</Box>
	);
	...
	const renderAgents = () => (
		<Box flexDirection="column">
			<Text color="cyan" bold>AI Agents Configuration</Text>
			<Text marginTop={1}>
				Configure at least one AI agent by adding the appropriate API key to your .env file:
			</Text>
			
			<Box marginTop={2}>
				<Text color="yellow" bold>Available Agents:</Text>
				...
				<Box marginTop={1} flexDirection="row" alignItems="center">
					...
					<Text marginLeft={1} bold>Claude Code</Text>
					<Text marginLeft={2} color="gray">(Recommended)</Text>
				</Box>
				...
				<Box marginTop={1} flexDirection="row" alignItems="center">
					...
					<Text marginLeft={1} bold>GPT-4 Codex</Text>
				</Box>
				...
				<Box marginTop={1} flexDirection="row" alignItems="center">
					...
					<Text marginLeft={1} bold>Gemini CLI</Text>
				</Box>
				...
				<Box marginTop={1} flexDirection="row" alignItems="center">
					...
					<Text marginLeft={1} bold>OpenCode</Text>
				</Box>
			...
			<Box marginTop={2} borderStyle="single" padding={1}>
				<Text color="cyan" bold>Getting API Keys:</Text>
	...
	const renderSandboxes = () => (
		<Box flexDirection="column">
			<Text color="cyan" bold>Sandbox Environments (Optional)</Text>
			<Text marginTop={1}>
			...
			<Box marginTop={2}>
				<Text color="yellow" bold>Available Providers:</Text>
				...
				<Box marginTop={1} flexDirection="row" alignItems="center">
					...
					<Text marginLeft={1} bold>E2B</Text>
					<Text marginLeft={2} color="gray">(Recommended)</Text>
				</Box>
				...
				<Box marginTop={1} flexDirection="row" alignItems="center">
					...
					<Text marginLeft={1} bold>Northflank</Text>
				</Box>
				<Text color="gray">  NORTHFLANK_API_KEY=your_northflank_api_key_here</Text>
				...
				<Box marginTop={1} flexDirection="row" alignItems="center">
					...
					<Text marginLeft={1} bold>Daytona</Text>
				</Box>
			...
			<Box marginTop={2} borderStyle="single" padding={1}>
				<Text color="cyan" bold>Getting Sandbox Access:</Text>
	...
	const renderGitHub = () => (
		<Box flexDirection="column">
			<Text color="cyan" bold>GitHub Integration (Recommended)</Text>
			<Text marginTop={1}>
				GitHub integration enables automatic branch creation, pull request management,
				and seamless collaboration workflows.
			</Text>
			...
			<Box marginTop={2} flexDirection="row" alignItems="center">
				...
				<Text marginLeft={1} bold>GitHub Token Status</Text>
			</Box>
			
			<Box marginTop={2}>
				<Text color="yellow" bold>Setup Instructions:</Text>
				<Text>1. Go to GitHub Settings → Developer settings → Personal access tokens</Text>
				...
				<Text color="gray">   • write:packages (Upload packages to GitHub Package Registry)</Text>
			...
			<Box marginTop={2}>
				<Text color="yellow" bold>Features Enabled:</Text>
			...
			<Box marginTop={2} borderStyle="single" padding={1}>
				<Text color="cyan" bold>Security Note:</Text>
				<Text>Your GitHub token is stored locally in .env and never shared.</Text>
				<Text>VibeKit uses it only for repository operations you authorize.</Text>
			</Box>
		</Box>
	);
	...
	const renderTroubleshooting = () => (
		<Box flexDirection="column">
			<Text color="cyan" bold>Troubleshooting & Common Issues</Text>
			
			<Box marginTop={2}>
				<Text color="red" bold>❌ "Missing API key for agent" Error:</Text>
				...
				<Text>• Restart the Flow TUI after adding new environment variables</Text>
				<Text>• Check for extra spaces or quotes around the API key</Text>
			</Box>
			
			<Box marginTop={2}>
				<Text color="red" bold>❌ "Network error" Issues:</Text>
			...
			<Box marginTop={2}>
				<Text color="red" bold>❌ "Sandbox initialization failed":</Text>
			...
			<Box marginTop={2}>
				<Text color="red" bold>❌ "GitHub operations failed":</Text>
			...
			<Box marginTop={2} borderStyle="single" padding={1}>
				<Text color="cyan" bold>Need More Help?</Text>
