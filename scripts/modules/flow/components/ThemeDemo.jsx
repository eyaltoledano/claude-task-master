...
import { themeManager, gradient, style, getComponentTheme } from '../theme-advanced.js';
...
export const ThemeDemo = () => {
  ...
  return (
    <Box flexDirection="column" padding={1}>
      ...
      <Box marginBottom={1}>
        <Text>
          {gradient('✨ Task Master Flow - Advanced Theme Demo ✨', ['primary', 'secondary'])}
        </Text>
      </Box>
      ...
      >
        <Box flexDirection="column">
          ...
          <Text>{style('Status: ', 'text.secondary')}
...
export const StatusBadge = ({ status, text }) => {
  ...
  return (
    ...
    >
      <Text color={themeManager.getColor(badge.text)}>
        {text || status}
      </Text>
    </Box>
  );
...
export const GradientTitle = ({ children, colors = ['primary', 'secondary'] }) => {
