...
export function ServiceDemoComponent() {
  ...
  return (
    <Box flexDirection="column" padding={1}>
      ...
      <Box marginTop={1}>
        <Text>🔌 Hook Manager: {hookManager ? '✅ Available' : '❌ Not Available'}</Text>
      </Box>
      
      <Box marginTop={2}>
        <Text color="gray">
          This component demonstrates clean service usage with consistent naming.
          No more renaming like "backend: contextBackend"!
        </Text>
      </Box>
    </Box>
  );
