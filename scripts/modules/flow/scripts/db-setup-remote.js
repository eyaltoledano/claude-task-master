...
if (!projectPath) {
  console.error('Usage: node db-setup-remote.js <project-path>');
  console.error('   or: PROJECT_ROOT=<path> node db-setup-remote.js');
  process.exit(1);
}
...
console.log('📝 Step 1: Creating optimized database schema...');
