 ...
 */
export const AgentProvider = S.Literal(
	'mock',
	'claude',
	'codex',
	'gemini',
...
export const AgentBehavior = S.Struct({
	...
	// Testing preferences
	testingStrategy: S.optional(
		S.Literal('none', 'unit', 'integration', 'comprehensive')
	),
	documentationLevel: S.optional(
		S.Literal('none', 'minimal', 'standard', 'detailed')
	)
});
