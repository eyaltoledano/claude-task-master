...
export class BatchProcessor extends EventEmitter {
    ...
    async initialize() {
        try {
            ...
            console.debug(`[BatchProcessor] Batch window: ${this.options.batchWindow}ms`);
    ...
    async addChange(changeAnalysis) {
        ...
        console.debug(`[BatchProcessor] Added change: ${changeAnalysis.relativePath} (${changeId})`);
    ...
    async _processTimeBatch() {
        ...
        console.debug(`[BatchProcessor] Processing batch of ${changes.length} changes`);
