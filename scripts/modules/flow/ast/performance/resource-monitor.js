...
export class ResourceMonitor extends EventEmitter {
    ...
    getRecommendedAnalysisDepth() {
        switch (this.degradationLevel) {
            case 0: return 'full';        // Normal operation
            case 1: return 'reduced';     // Skip detailed pattern analysis
            case 2: return 'minimal';     // Basic parsing only
            case 3: return 'disabled';    // No AST analysis
            default: return 'full';
        }
    }
    ...
    getRecommendedConcurrency() {
        ...
        switch (this.degradationLevel) {
            case 0: return baseConcurrency;
            case 1: return Math.max(1, Math.floor(baseConcurrency * 0.75));
            case 2: return Math.max(1, Math.floor(baseConcurrency * 0.5));
            case 3: return 0; // No concurrent operations
    ...
    _collectMetrics() {
        ...
        this.metrics.peakMemoryUsage = Math.max(this.metrics.peakMemoryUsage, memoryUsage.used);
    ...
    _getIOUsage() {
        ...
        const activityScore = Math.min(100, (currentStats.operations / timeDiff) * 1000 * 10);
