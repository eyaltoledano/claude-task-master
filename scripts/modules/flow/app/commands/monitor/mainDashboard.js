...
function createMainDashboard(screen) {
  ...
  const updateDashboard = (telemetryData) => {
    ...
    agentActivity.setData([
      { title: 'Codex', x: sampleData.timestamps, y: sampleData.codexRequests, style: {line: 'yellow'} },
      { title: 'Claude', x: sampleData.timestamps, y: sampleData.claudeRequests, style: {line: 'cyan'} }
    ]);
