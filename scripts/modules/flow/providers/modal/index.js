...
import { ModalError, ModalConnectionError, ModalExecutionError } from './errors.js'
...
export class ModalProvider {
  ...
  async updateResource(resourceId, updates = {}) {
    try {
      ...
      if (updates.environment) {
        ...
        console.warn('Modal functions are immutable. Environment updates require recreation.')
      }
  ...
  async executeAction(resourceId, action, parameters = {}) {
    try {
      ...
      const { code, language = 'python', timeout = 300000, args = [] } = parameters
