...
export async function formatEnhancedClaudeContext(
	...
	const hasEnhancedAnalysis =
		enhancedResults && enhancedResults.success && enhancedResults.enabled;

	// Start with unified header
	let context = generateUnifiedHeader(
		worktreePath,
		enhancedResults,
		hasEnhancedAnalysis
	);
...
`;
		...
		const errorInfo = enhancedResults?.error
