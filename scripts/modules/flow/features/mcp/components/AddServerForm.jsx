            ...
            >
                ...
                <Box>
                    <Box
                        ...
                        borderStyle="single"
                        borderColor={
                            formField === 'submit' ? theme.accent : theme.border
                        }
                    >
                        <Text
                            color={
                                formField === 'submit' ? theme.accent : theme.text
                            }
                        >
                            Submit
                        </Text>
                    ...
                    <Box
                        ...
                        borderStyle="single"
                        borderColor={
                            formField === 'cancel' ? theme.accent : theme.border
                        }
                    >
                        <Text
                            color={
                                formField === 'cancel' ? theme.accent : theme.text
                            }
                        >
                            Cancel
                        </Text>
