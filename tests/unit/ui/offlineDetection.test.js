...
describe('Offline Mode Detection', () => {
    ...
    const loadOfflineDetector = async () => {
        ...
        const module = await import('../../../src/ui/client/js/components/offlineDetector.js');
    ...
    describe('UI Indicators', () => {
        it.skip('should show offline indicator when offline', async () => {
            ...
            expect(indicator.classList.contains('offline-indicator-visible')).toBe(true);
        });
        ...
        it('should hide offline indicator when online', async () => {
            ...
            const indicator = document.querySelector('.offline-indicator');
            expect(indicator.classList.contains('offline-indicator-visible')).toBe(false);
        });
    ...
    describe('Storage Persistence', () => {
        it('should persist offline state in sessionStorage', async () => {
            ...
            expect(window.sessionStorage.setItem).toHaveBeenCalledWith('offline-mode', 'false');
        });
