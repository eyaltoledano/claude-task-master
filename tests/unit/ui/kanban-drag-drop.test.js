...
describe('Kanban Drag-and-Drop', () => {
    ...
    describe('API Integration', () => {
        ...
        it('should handle API errors gracefully', async () => {
            ...
            await expect(kanban.updateTaskStatus('1', 'done'))
    ...
    describe('Rollback Mechanism', () => {
        it('should rollback card position on API failure', async () => {
            ...
            const backlogContainer = document.querySelector('[data-column="backlog"]');
            const inProgressContainer = document.querySelector('[data-column="in-progress"]');
