...
export const loading = {
    start: (element, options) => getLoadingManager().startLoading(element, options),
    stop: (loaderId) => getLoadingManager().stopLoading(loaderId),
    showOverlay: (message, options) => getLoadingManager().showOverlay(message, options),
    hideOverlay: (loaderId) => getLoadingManager().hideOverlay(loaderId),
    showSkeleton: (container, type, options) => getLoadingManager().showSkeleton(container, type, options),
    ...
    updateProgress: (progressId, progress) => getLoadingManager().updateProgress(progressId, progress),
