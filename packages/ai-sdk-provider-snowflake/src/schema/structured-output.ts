...
// Re-export static methods as standalone functions for use by other modules
...
export function extractFirstJsonObject(text: string): string | null {
	return StructuredOutputGenerator.extractFirstJsonObject(text);
}
 ...
 * @throws Error if parsing fails
 */
export function parseJsonWithFallback(jsonText: string): unknown {
	return StructuredOutputGenerator.parseWithFallback(jsonText);
}
 ...
 * @throws Error if no valid JSON can be extracted
 */
export function extractAndParseJson(responseText: string): unknown {
	return StructuredOutputGenerator.extractAndParse(responseText);
}
