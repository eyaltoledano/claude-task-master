...
Default: `standard` (14 tools). Set via `TASK_MASTER_TOOLS` env var.
...
**Upgrade when tool unavailable:** Edit MCP config, change `TASK_MASTER_TOOLS` from `"standard"` to `"all"`, restart MCP.
