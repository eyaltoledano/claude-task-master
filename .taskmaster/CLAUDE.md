...
| Tier | Tools | Use Case |
|------|-------|----------|
| `core` | 7 | Minimal daily workflow tools |
| `standard` | 14 | Common task management (default) |
...
**To upgrade tiers:** Change `TASK_MASTER_TOOLS` in `.mcp.json` from `"standard"` to `"all"` and restart the MCP connection.
