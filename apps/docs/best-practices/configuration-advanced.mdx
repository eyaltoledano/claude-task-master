...
**Configuration:**
API storage is configured through the tm-core initialization process. No additional configuration files are needed - the system automatically detects the storage type at runtime and routes operations accordingly.