...
- **Provider**: Azure AI Foundry (Microsoft Foundry)
- **Required**: ✅ **Yes**
- **Requirements**: Also requires `AZURE_AI_FOUNDRY_ENDPOINT` configuration
- **Models**: Various models deployed in Azure AI Foundry (GPT, Claude, Llama, Mistral, etc.)
- **Get Key**: [Azure Portal](https://portal.azure.com/)

```bash
AZURE_AI_FOUNDRY_API_KEY="your-azure-ai-foundry-key-here"
...
- **Azure AI Foundry**: Requires both `AZURE_AI_FOUNDRY_API_KEY` and `AZURE_AI_FOUNDRY_ENDPOINT` configuration
