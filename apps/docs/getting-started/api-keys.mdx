...
- **Get Key**: [Z.ai Platform](https://api.z.ai/)
...
Z.ai offers two separate provider endpoints that use the same API key but serve different subscription tiers:

#### zai (Standard Endpoint)
- **Endpoint**: `https://api.z.ai/api/paas/v4/`
- **Models**: `glm-4.6`, `glm-4.5`  
- **Usage**: Standard Z.ai API access

#### zai-coding (Coding Plan Endpoint) 
- **Endpoint**: `https://api.z.ai/api/coding/paas/v4/`
- **Models**: `glm-4.6`, `glm-4.5` (same model IDs)
- **Usage**: Dedicated coding plan subscription endpoint

When running `task-master models --setup`, you'll see both providers listed separately:
- `zai / glm-4.6` - Standard endpoint
- `zai-coding / glm-4.6` - Coding Plan endpoint

Choose the provider that matches your Z.ai subscription plan.
