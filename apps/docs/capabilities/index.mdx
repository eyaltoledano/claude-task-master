...
The system automatically detects the storage mode and routes operations accordingly, maintaining consistent CLI and MCP interfaces regardless of backend. 
