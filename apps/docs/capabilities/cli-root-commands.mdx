...
<AccordionGroup>
  ...
  <Accordion title="Clear Subtasks">
    <Info>**Local-Only Command**: Subtask clearing is only available when using local file storage. If you're authenticated with Hamster (remote storage), this command will be blocked. Run `task-master auth logout` to use local storage and access this command.</Info>
  ...
  <Accordion title="Managing Task Dependencies">
    <Info>**Local-Only Commands**: Dependency management commands are only available when using local file storage. If you're authenticated with Hamster (remote storage), these commands will be blocked. Run `task-master auth logout` to use local storage and access these commands.</Info>
