...
-   **`update_task`**: Updates a single task. *Automatically delegated to remote AI services when using API storage.*
-   **`update_subtask`**: Appends information to a subtask. *Automatically delegated to remote AI services when using API storage.*
