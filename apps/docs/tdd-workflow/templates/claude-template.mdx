...
See [AI Agent Integration Guide](../ai-agent-integration.md) for complete MCP documentation.
...
- [AI Agent Integration Guide](../ai-agent-integration.md) - Complete integration documentation
- [Command Reference](../command-reference.md) - All CLI commands
- [Task Structure](../task-structure.md) - Understanding tasks and subtasks
...
**For detailed documentation, see:** [AI Agent Integration Guide](../ai-agent-integration.md)
