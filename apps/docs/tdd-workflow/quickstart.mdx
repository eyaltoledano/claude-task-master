...
✓ Created branch: tm/task-7-implement-autopilot-workflow
✓ Current phase: RED
...
Your branch `tm/task-7-implement-autopilot-workflow` is ready for review/merge!
...
$ tm autopilot start 7 --json | jq .
{
  "success": true,
  "taskId": "7",
  "branchName": "tm/task-7-implement-autopilot-workflow",
  "phase": "SUBTASK_LOOP",
  "tddPhase": "RED",
  "progress": { ... },
  "currentSubtask": { ... },
